const dev = {
    ...
    PAST_REPORTS_API_URL: 'http://localhost:8080/api/v1/PastReports/getReport',
...
const prod = {
    ...
    PAST_REPORTS_API_URL: 'http://cmpt373-1211-11.cmpt.sfu.ca:8080/api/v1/PastReports/getReport',
