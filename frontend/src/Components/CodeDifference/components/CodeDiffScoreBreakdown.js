...
const CodeDiffScoreBreakdown = (prop) => {
    const{ extension, linesMoved, addLine, syntaxLinesAdded, deleteLine, configInfo, spaceLinesAdded } = prop || {}
                        ...
                        <Table className='table-breakdown'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{addLine-spaceLinesAdded-syntaxLinesAdded-linesMoved}</td>
                                    <td>{deleteLine}</td>
                                    <td>{linesMoved}</td>
                    ...
                    <Card.Body>
                        <Table className='table-breakdown'>
                            <tbody>
                                ...
                                <tr>
                                    <th>meaningfulLinesAdded</th>
                                    <td>{configInfo.editFactor.addLine} * {addLine-spaceLinesAdded-syntaxLinesAdded-linesMoved}</td>
                                    <td className='part-calc'>{((configInfo.editFactor.addLine) * (addLine-spaceLinesAdded-syntaxLinesAdded-linesMoved)).toFixed(1)}</td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {((configInfo.editFactor.addLine) * (addLine-spaceLinesAdded-syntaxLinesAdded-linesMoved)).toFixed(1)}+ 
