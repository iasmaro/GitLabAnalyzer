...
2. Create a branch (either locally or through GitLab) for the issue you created (or any issue that no one is 
   currently working on and you want to start working on it)
    ...
    "lift component up", name your branch as "9-lift-component-up"
      - NOTE: if you create a branch to work on multiple issue, say issue number 6, 8, 10, then name your branch as: `close-6-8-10` and when you submit your merge request, in the description, enter `Closes #6, #8, #10` to trigger the closing issues automatically feature (more details, see step 4 bellow).
